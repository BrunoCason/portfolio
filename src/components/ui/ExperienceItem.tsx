  ...
  return (
    <div>
      {experiences.map((exp, index) => (
        <div
          key={index}
          className="mx-0 sm:mx-10 md:mx-10 2xl:mx-48 p-8 bg-gray-50 dark:bg-gray-900 rounded-xl shadow-lg lg:grid grid-cols-3 mb-8 md:mb-12 transition-colors duration-500 ease-in-out"
        >
          <div>
